			...
			<div className='space-y-4'>
				<div className='space-y-2'>
					...
					<dl className='flex items-center justify-between gap-4 border-t border-gray-600 pt-2'>
						...
						<dd className='text-base font-bold text-emerald-400'>NRs {formattedTotal}</dd>
					</dl>
				</div>
				...
				<div className='flex items-center justify-center gap-2'>
					...
					<Link
						to='/'
						className='inline-flex items-center gap-2 text-sm font-medium text-emerald-400 underline underline-offset-2 hover:text-emerald-300 hover:no-underline'
					>
						Continue Shopping
						<MoveRight size={16} />
					</Link>
